...
export default async function StoryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
   ...
   <div className="flex flex-col gap-3 items-center text-center justify-center p-4 md:p-10 w-full md:w-1/2">
  ...
  <h1 className="text-4xl md:text-5xl lg:text-7xl mt-5 md:mt-0 w-full px-4">
    {story.title}
  </h1>
  <div className="text-2xl mt-10 hidden md:block">
    <p>{story.custom_tag && <span className="font-extrabold">{story.custom_tag}.</span>} {story.subheader}</p>
      ...
      <div className="text-xl lg:text-2xl max-w-[80%] md:max-w-[50%] mt-10 mx-auto">
       {story.url && story.url.trim() !== '' && (
         <p className="mb-10 text-xs md:text-lg font-mono">
           This story was originally published elsewhere. This is a nicer looking, ad-free version. To read the original, <a href={story.url.startsWith('http') ? story.url : `https://${story.url}`} target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">click here</a>.
         </p>
       )}
